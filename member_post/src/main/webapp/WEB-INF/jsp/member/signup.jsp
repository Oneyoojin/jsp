    ...
    <div class="wrap">
        <header class="container-fluid">
            <div class="container clearfix p-2">
                <a href="index.html" class="float-start"><img src="https://cdn.discordapp.com/.../unnamed.png" alt="로고" width="250px"></a>
            </div>
        </header>
        ...
        <main class="container">
            ...
            <form name="frm" class="mx-auto col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 card p-2 mt-5">
                ...
                <ul class="list-group search-result-wrap"></ul>
